...
export default function DetailCV() {
  ...
  const gitRepositories: gitRepositoryInterface.gitRepository[] =
    useAppSelector((state) => state.gitRepository.gitRepository);
  ...
  return (
    <div
      className={`detailCV ${
        context?.isDarkMode ? "detailDarkMode" : "detailLightMode"
      }`}
    >
      <div className="detailAvatarContainerCV">
        <AvatarCard
          ...
          classNameText={`detailAvatarNameCV ${
            context?.isDarkMode
              ? "darkModeDetailsLetters"
              : "ligthModeDetailsLetters"
          }`}
          gitUser={gitUser}
        />
      </div>
        ...
        <div>
          ...
          <div className="detailProjectsContainerCV">
            ...
            <div className="repositoryDetailContainer">
              ...
              <ul>
                {gitRepositories &&
                  gitRepositories.map((url, index) => (
                    <li
                      className={`repositoryOption ${
                        context?.isDarkMode
                          ? "darkModeDetailsLetters"
                          : "ligthModeDetailsLetters"
                      }`}
